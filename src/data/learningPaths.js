...
export const LEARNING_PATHS = [
  ...
  },
  {
    ...
    depth: 'intermedi',
    durationEstimate: '~5 h',
    description: 'Com funciona la vida a nivell cel·lular, com l\'evolució ens ha modelat, com l\'ADN guarda la informació i com el cervell genera pensament.',
    accentColor: '#3DDC84',
    areaId: 'ciencies',
    modules: [
  ...
  },
  {
    ...
    depth: 'profund',
    durationEstimate: '~8 h',
    description: 'Newton, la termodinàmica, l\'electromagnetisme, la mecànica quàntica i la relativitat general. El programa complet de la física moderna.',
    accentColor: '#A78BFA',
    areaId: 'ciencies',
    modules: [
  ...
  },
  {
    ...
    depth: 'profund',
    durationEstimate: '~7 h',
    description: 'Conflictes armats, drets humans, tribunals internacionals i els límits de la sobirania estatal. Tot el que cal saber per entendre el món que volem construir.',
    accentColor: '#5B9BD5',
    areaId: 'relacions',
    modules: [
