export const MODULE_REGISTRY = [
  ...
  { id: 'module-bio-catalina',     phase: 1, order: 110, file: () => import('./modules/module-bio-catalina.json') },
  { id: 'module-bio-robespierre',  phase: 1, order: 111, file: () => import('./modules/module-bio-robespierre.json') },
  { id: 'module-bio-trotsky',      phase: 1, order: 112, file: () => import('./modules/module-bio-trotsky.json') },
  { id: 'module-bio-mandela',      phase: 1, order: 113, file: () => import('./modules/module-bio-mandela.json') },
  { id: 'module-bio-eleanor',      phase: 1, order: 114, file: () => import('./modules/module-bio-eleanor.json') },
  { id: 'module-bio-olympe',       phase: 1, order: 115, file: () => import('./modules/module-bio-olympe.json') },
  { id: 'module-bio-marcaureli',   phase: 1, order: 116, file: () => import('./modules/module-bio-marcaureli.json') },
  { id: 'module-bio-cicero',       phase: 1, order: 117, file: () => import('./modules/module-bio-cicero.json') },
  { id: 'module-bio-ataturk',      phase: 1, order: 118, file: () => import('./modules/module-bio-ataturk.json') },
  { id: 'module-bio-marx',         phase: 1, order: 119, file: () => import('./modules/module-bio-marx.json') },
  { id: 'module-bio-nietzsche',    phase: 1, order: 120, file: () => import('./modules/module-bio-nietzsche.json') },
  { id: 'module-bio-freud',        phase: 1, order: 121, file: () => import('./modules/module-bio-freud.json') },
  { id: 'module-bio-darwin',       phase: 1, order: 122, file: () => import('./modules/module-bio-darwin.json') },
  { id: 'module-bio-leonardo',     phase: 1, order: 123, file: () => import('./modules/module-bio-leonardo.json') },
  { id: 'module-bio-mlk',          phase: 1, order: 124, file: () => import('./modules/module-bio-mlk.json') },
  { id: 'module-bio-luxemburg',    phase: 1, order: 125, file: () => import('./modules/module-bio-luxemburg.json') },
  { id: 'module-bio-tubman',       phase: 1, order: 126, file: () => import('./modules/module-bio-tubman.json') },
  { id: 'module-bio-gramsci',      phase: 1, order: 127, file: () => import('./modules/module-bio-gramsci.json') },
  { id: 'module-bio-einstein',     phase: 1, order: 128, file: () => import('./modules/module-bio-einstein.json') },
  { id: 'module-bio-newton',       phase: 1, order: 129, file: () => import('./modules/module-bio-newton.json') },
  { id: 'module-bio-curie',        phase: 1, order: 130, file: () => import('./modules/module-bio-curie.json') },
  { id: 'module-bio-kant',         phase: 1, order: 131, file: () => import('./modules/module-bio-kant.json') },
  { id: 'module-bio-arendt',       phase: 1, order: 132, file: () => import('./modules/module-bio-arendt.json') },
  { id: 'module-bio-beauvoir',     phase: 1, order: 133, file: () => import('./modules/module-bio-beauvoir.json') },
  { id: 'module-bio-planck',       phase: 1, order: 134, file: () => import('./modules/module-bio-planck.json') },
  { id: 'module-bio-jfk',          phase: 1, order: 135, file: () => import('./modules/module-bio-jfk.json') },
  { id: 'module-bio-binladen',     phase: 1, order: 136, file: () => import('./modules/module-bio-binladen.json') },
]
